...
export const testdata: {} = {
    ...
    test5: {
        ...
        "components": [
            {
                "accessURL": "https://www.nist.gov/itl/iad/image-group/special-database-32-multiple-encounter-dataset-meds",
                "description": "This page presents a registration form that must be completed to download the restricted data.",
                "title": "Gateway for Registered Data Access",
                "format": {
                    "description": "JPEG formatted images"
                },
            ...
            {
                "accessURL": "https://doi.org/10.18434/mds0000fbk",
                "title": "DOI Access to \"Multiple Encounter Dataset (MEDS-II)\"",
                "@type": [
                    "nrdp:DataFile",
                    "dcat:Distribution",
                    "nrdp:AccessPage"
